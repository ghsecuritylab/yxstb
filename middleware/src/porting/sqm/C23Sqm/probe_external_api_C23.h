 #ifndef __probe_external_api_C23_h__
#define __probe_external_api_C23_h__
...
typedef struct stb_info_values
{
    ...
    /* STB版本号 */                          
    //MDI_CHAR     sSTBVersion[MAX_ID_LEN];
...
{
    /*媒体传输类型:  1:单播   2:组播   3:HTTP单播   4:HTTP组播*/
    CHN_STAT   MediaType;
...
MDI_INT32 PROBE_ReportStbStatus(stb_ip_change_t *pStbChangeInfo, 
    MDI_INT16 *pnErrNum);
