...
/*begin add by chenjincong 59624 for pppoe problem in 2009-08-14*/
//网络接入类型
...
//当前可识别的最大告警ID
#define CUR_MAX_ALARM_ID 18

#define ALARM_TOTAL 18
...
#define LINK_EM  1
#define LINK_DM  2
#define LINK_MULTICAST 3
#define LINK_DETECT  4
#define LINK_TRACE 5
