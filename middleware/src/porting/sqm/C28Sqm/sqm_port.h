...
//C28 ÓÃÀ´»ñÈ¡sqm´«¹ıÀ´µÄsqmÊı¾İ.
typedef struct  SQM_MSG_DATA
{
	int df;				//DFÖµ£¬Sqmpro³ËÒÔ1000È¡Õû£¬STBÊÕµ½ºó³ıÒÔ1000
	int mlr;				//Ã¿Ãë¶ª°üÊı£¬Í³¼ÆÊı¾İÆ½¾ùÖµ³ËÒÔ106È¡Õû£¬Ãë¼¶Êı¾İºÍÍ³¼ÆÊı¾İ×î´óÖµ£¬×îĞ¡Öµ²»×ö´¦Àí
	int jitter;			//¶¶¶¯Öµ£¬Sqmpro³ËÒÔ1000È¡Õû£¬MQMCÊÕµ½ºó³ıÒÔ1000
	int OtherIndex1;		//±£ÁôÖ¸±ê×Ö¶Î£¬Ô¤ÁôºóĞøÀ©Õ¹£¬µ±Ç°Ä¬ÈÏÖµ0
	int OtherIndex2;		//±£ÁôÖ¸±ê×Ö¶Î£¬Ô¤ÁôºóĞøÀ©Õ¹£¬µ±Ç°Ä¬ÈÏÖµ0
}SQM_GET_DATA;
...
int sqm_port_getmsg(void*, int, int);
