...
typedef enum
{
    ...
    DLNA_EVENT_FILELIST_UPDATE,         /* 文件列表更新 */
    DLNA_EVENT_DMR_SETMUTE,             /* 设置静音 */
    DLNA_EVENT_DMR_SETVOLUME,           /* 设置音量 */
    DLNA_EVENT_DMR_GETMUTE,             /* 获取静音状态 */
    DLNA_EVENT_DMR_GETVOLUME,           /* 获取音量 */
    DLNA_EVENT_DMR_PLAY,                /* 播放 */
    DLNA_EVENT_DMR_PAUSE,               /* 暂停 */
    DLNA_EVENT_DMR_RESUME,              /* 恢复 */
    DLNA_EVENT_DMR_SEEK,                /* 定位 */
    DLNA_EVENT_DMR_STOP,                /* 结束 */
    DLNA_EVENT_DMR_GETPOSITIONINFO,     /* 获取当前位置信息 */
    DLNA_EVENT_DMR_GETTRANSPORTINFO,     /* 获取Transport信息 dinglei*/
    DLNA_EVENT_DMR_GETMEDIAINFO,     /* 获取媒体信息 dinglei*/
    DLNA_EVENT_DMR_NONE,                /* 无效 */
    EVENT_DLNA_CHANNEL_RESOURCE_CHANGED, /*共享频道播放冲突事件*/
    DLNA_EVENT_DMR_SETTRANSFORMS_ZOOM, /*设置展现的变换dinglei*/
    DLNA_EVENT_DMR_GETPRODUCTINFO,/*：得到与待播内容关联的产品列表dinglei*///roductInfo
    DLNA_EVENT_DMR_ORDER,/*订购dinglei*/
    DLNA_EVENT_DMR_RemoteKey                /* 模拟键值 */


}HY_DLNA_EVENTID;
typedef enum
{
	DLNA_GETINSTANCEID = 0,
	DLNA_GETVOLUME,
	DLNA_GETMUTE,
	DLNA_GETPOSITION,
	DLNA_GETDURATION
...
typedef void (*RmdmsfilelistCallback) (const char* aFieldName,const char *deviceID,char *out,int len);
