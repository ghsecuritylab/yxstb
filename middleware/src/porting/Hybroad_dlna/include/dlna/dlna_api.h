...
int Set_RmDmsFileList_Callback (RmdmsfilelistCallback fun);
...
/*basic  dmr interface */
extern int Dmr_Init(char *name);
//extern int Dmr_Start(void);
int Dmr_Start(DMREVRNT_CALLBACK Callback);
extern void Dmr_Stop(void);
extern int Dmr_DealRemoteRequest( int AcceptOrNot);
